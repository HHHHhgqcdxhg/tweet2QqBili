...
CREATE TABLE `qq_group_info`  (
  `group_id` bigint(20) NOT NULL COMMENT '裙号',
...
CREATE TABLE `tweet2bili`  (
  ...
  `bili_id` bigint(20) NOT NULL COMMENT '转推至 的bilibili账号id',
...
CREATE TABLE `tweet2qq`  (
  ...
  `format` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '{tweet_nick_name} 新推特:{url}|{content}|{trans}' COMMENT '转推消息格式',
