...
public class BiliAccountParam {
     ...
     * @mbg.generated
     */
    public BiliAccountParam appendOrderByClause(OrderCondition orderCondition, SortType sortType) {
     ...
     * @mbg.generated
     */
    public BiliAccountParam setPage(boolean page) {
        this.page = page;
        return this;
    }
     ...
     * @mbg.generated
     */
    public BiliAccountParam setPageSize(int pageSize) {
     ...
     * @mbg.generated
     */
    public BiliAccountParam setPageStart(int pageStart) {
     ...
     * @mbg.generated
     */
    public BiliAccountParam appendDistinct(OrderCondition condition) {
        if (null != distinctSql){
